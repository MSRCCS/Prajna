...
/// </summary>
type CacheService = Prajna.Service.CacheService
...
/// </summary>
type WorkerRoleInstance = Prajna.Service.WorkerRoleInstance

// <summary>
/// WorkerRoleInstance is extended to run a service. It is to be instantiated at the remote end so that it is class member 
/// does not have the constraint to be serializable. 
/// </summary>
type WorkerRoleInstance<'StartParamType> = Prajna.Service.WorkerRoleInstanceGeneric<'StartParamType>
...
/// </summary> 
type WorkerRoleInstanceStartParam = Prajna.Service.WorkerRoleInstanceStartParam
...
type RemoteInstance() = 
    ...
    static member Start<'StartParamType, 'RType 
        ...
        Prajna.Service.RemoteInstance.InternalStartInstanceOnClusterWithParam cl serviceName param ( func  )
    /// <summary>
    /// Launching Prajna Service on a group of remote nodes.
    /// serviceName: name of the serivce
    /// param: parameter to be called by OnStart, must derive from WorkerRoleInstanceStartParam
    /// func: the function to initialized the WorkerRoleInstance. This function will be executed as a closure remotely. The returned class must derive from WorkerRoleInstance.
    /// </summary>
    static member Start<'StartParamType, 'RType when 'StartParamType :> WorkerRoleInstanceStartParam
                                                and 'RType :> WorkerRoleInstance > (serviceName, param, func: unit->'RType )  =
    ...
    /// func: the function to initialized the WorkerRoleInstance. This function will be executed as a closure remotely. The returned class must derive from WorkerRoleInstance.
    /// </summary>
    static member Start<'RType when 'RType :> WorkerRoleInstance > (serviceName:string, func:unit->'RType )  =
        let param = WorkerRoleInstanceStartParam()
        RemoteInstance.InternalStartInstanceOnClusterWithParam<_,'RType> null serviceName param func
    /// <summary>
    ...
    /// </summary>
    static member StartLocal<'StartParamType, 'RType when 'StartParamType :> WorkerRoleInstanceStartParam
                                                                        and 'RType :> WorkerRoleInstance > 
                                                                        (serviceName, param: 'StartParamType, func:unit->'RType)  =
    ...
    ///         isRunning ( a Func that can be called to evaluate if the current RoleInstance is still running)
    /// </summary>
    static member StartLocal<'RType when 'RType :> WorkerRoleInstance > (serviceName, func:unit->'RType )  =
        let param = WorkerRoleInstanceStartParam()
        RemoteInstance.InternalStartLocalInstanceWithParam serviceName param func
    ...
    static member Start<'StartParamType, 'RType 
        ...
        RemoteInstance.InternalStartInstanceOnServersWithParam<_,_> serverInfo serviceName param func
    /// <summary>
